...
namespace IT								// таблица идентификаторов 
{
	...
	struct Entry							// строка таблицы идентификаторов
	{
		...
		Entry(const char* parrentFunc, const char* id, IDDATATYPE iddatatype, IDTYPE idtype,int it);
		Entry(const char* parrentFunc, const char* id, IDDATATYPE iddatatype, IDTYPE idtype, char* str);
		Entry(const char* parrentFunc, const char* id, IDDATATYPE iddatatype, IDTYPE idtype, const char* str);
